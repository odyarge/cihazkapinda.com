...
namespace ODY.Cihazkapinda.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update CihazkapindaDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update CihazkapindaEfCoreEntityExtensionMappings to extend the IdentityUser entity
