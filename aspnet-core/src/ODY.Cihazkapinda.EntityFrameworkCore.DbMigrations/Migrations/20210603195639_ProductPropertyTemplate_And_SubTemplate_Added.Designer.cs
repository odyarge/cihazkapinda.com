...
namespace ODY.Cihazkapinda.Migrations
{
    ...
    [Migration("20210603195639_ProductPropertyTemplate_And_SubTemplate_Added")]
    partial class ProductPropertyTemplate_And_SubTemplate_Added
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ODY.Cihazkapinda.BannerImages.BannerImage", b =>
                {
                    ...
                    b.Property<Guid>("BannerSettingId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("BannerSettingId");

                    b.ToTable("AppBannerImage");
                });

            modelBuilder.Entity("ODY.Cihazkapinda.BannerSettings.BannerSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppBannerSetting");
                });

            modelBuilder.Entity("ODY.Cihazkapinda.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ODY.Cihazkapinda.ProductManagement.ProductImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ODY.Cihazkapinda.ProductManagement.ProductProperty", b =>
                {
                    ...
                    b.ToTable("AppProductProperty");
                });

            modelBuilder.Entity("ODY.Cihazkapinda.ProductManagement.ProductPropertySubTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ProductPropertyTemplateId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ProductPropertyTemplateId");

                    b.ToTable("AppProductPropertySubTemplate");
                });
            ...
            modelBuilder.Entity("ODY.Cihazkapinda.ProductManagement.ProductPropertyTemplate", b =>
                {
                    ...
                    b.ToTable("AppProductPropertyTemplate");
                });

            modelBuilder.Entity("ODY.Cihazkapinda.ProductManagement.ProductPropertyTitle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppProductPropertyTitle");
                });

            modelBuilder.Entity("ODY.Cihazkapinda.SiteSettings.SiteSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime>("SITE_LICENSE_FINISH_TIME")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("SITE_OPERATOR")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SITE_OWNER")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("AppSiteSetting");
                });

            modelBuilder.Entity("ODY.Cihazkapinda.ThemeSettings.ThemeSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("THEME_ACTIVATED")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("THEME_PATH")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("THEME_PRO")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("ODY.Cihazkapinda.BannerImages.BannerImage", b =>
                {
                    b.HasOne("ODY.Cihazkapinda.BannerSettings.BannerSetting", "BannerSetting")
                        .WithMany("Images")
                        .HasForeignKey("BannerSettingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BannerSetting");
                });

            modelBuilder.Entity("ODY.Cihazkapinda.ProductManagement.Product", b =>
                {
                    b.HasOne("ODY.Cihazkapinda.Categories.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("ODY.Cihazkapinda.ProductManagement.ProductProperty", b =>
                {
                    b.HasOne("ODY.Cihazkapinda.ProductManagement.Product", "Product")
                        ...
                        .HasForeignKey("ODY.Cihazkapinda.ProductManagement.ProductProperty", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ODY.Cihazkapinda.ProductManagement.ProductPropertySubTemplate", b =>
                {
                    b.HasOne("ODY.Cihazkapinda.ProductManagement.ProductPropertyTemplate", "ProductPropertyTemplate")
                        .WithMany("ProductPropertySubTemplates")
                        .HasForeignKey("ProductPropertyTemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ProductPropertyTemplate");
                });
            ...
            modelBuilder.Entity("ODY.Cihazkapinda.ProductManagement.ProductPropertyTemplate", b =>
                {
                    b.Navigation("ProductPropertySubTemplates");
                });
